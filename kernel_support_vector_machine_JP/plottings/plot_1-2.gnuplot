...
set yrange [0:1]
set zrange [-4:4]
set title 'SVM and plain regression'
unset colorbox
...
replot -10*x-10*y+9                   with lines lw 2 palette            title 'Regression plain'
replot "data_line_3d.csv" using 1:2:3 with lines lw 4       lc '#666666' title 'Classification boundary'
