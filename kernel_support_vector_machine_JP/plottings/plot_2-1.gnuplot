...
set xrange [0:1]
set yrange [0:1]
set title 'Sigma = 0.5, Lambda = 1.0E-5'
unset colorbox
...
replot "data_reg_3d.csv"   using 1:2:3 with lines lw 2 palette            title 'Regression curve'
replot "data_bound_3d.csv" using 1:2:3 with lines lw 4       lc '#666666' title 'Classification boundary'
replot 0                               with lines lw 1       lc '#666666' title 'z = 0'
